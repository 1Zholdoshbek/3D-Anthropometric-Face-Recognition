...
dirname = "D:/faceRecognition/features/"
RangeFile = os.listdir(dirname)
for file1 in RangeFile:
    f1 = open('D:/faceRecognition/features/'+file1,'r')
    f1file = f1.read()
    ftemp = file1[0:4]
    for file2 in RangeFile:
        ftarget = ftemp+ '-' + file2
        f2 = open('D:/faceRecognition/features/'+file2,'r')
        f2file = f2.read()
        f  = open('D:/faceRecognition/dataset/'+ftarget,'w')
        f2.close()
